...
class BudgetPCTotalPrice extends Component{
    constructor(props){
        super(props);
   ...
   async OrderPC(event){
      ...
      render() {
        const {minp} = this.props.location.state;
        const {maxp} = this.props.location.state;
        console.log(minp);
        console.log(maxp);
        const {totalprice} = this.props.location.state;
        ...
        return (
          <div className="container">
              ...
              <h2 class="text-center mb-3" className="Label"><i class="fas fa-sign-in-alt"></i>Budget PC Configuration Information
              </h2>
              <br></br>
              <br></br>
              <br></br>
              <Link className="link" to={{
                  pathname:'/pcconfigurations',
                  state:{name: this.name, minprice: minp, maxprice: maxp}
              }}> Back to PC Configurations Page </Link>
              <br></br>
              <br></br>
              <br></br>
  ...
  export default connect(mapStateToProps)(BudgetPCTotalPrice);